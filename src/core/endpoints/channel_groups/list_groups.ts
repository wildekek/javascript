import { ListAllGroupsResponse, ModulesInject } from '../../interfaces';
...
export function handleResponse(modules: ModulesInject, serverResponse: any): ListAllGroupsResponse {
  return {
