import { ListChannelsParams, ListChannelsResponse, ModulesInject } from '../../interfaces';
...
export function handleResponse(modules: ModulesInject, serverResponse: any): ListChannelsResponse {
  return {
