import { GetStateArguments, GetStateResponse, ModulesInject } from '../../interfaces';
...
export function handleResponse(modules: ModulesInject, serverResponse: any, incomingParams: GetStateArguments): GetStateResponse {
