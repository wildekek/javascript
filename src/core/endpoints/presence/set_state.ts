import { SetStateArguments, SetStateResponse, ModulesInject } from '../../interfaces';
...
export function handleResponse(modules: ModulesInject, serverResponse: any): SetStateResponse {
