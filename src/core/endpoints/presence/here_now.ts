import { HereNowArguments, ModulesInject } from '../../interfaces';
...
export function handleResponse(modules: ModulesInject, serverResponse: any, incomingParams: HereNowArguments): Object {
