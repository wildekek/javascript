import { WhereNowArguments, WhereNowResponse, ModulesInject } from '../../interfaces';
...
export function handleResponse(modules: ModulesInject, serverResponse: any): WhereNowResponse {
