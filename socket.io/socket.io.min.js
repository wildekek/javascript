...
typeof c.length))throw Error("JSON.stringify");return b("",{"":a})});"function"!==typeof JSON.parse&&(JSON.parse=function(a){return eval("("+a+")")})}();var aa=1,u=r,ba=[],v="-pnpres",ca=10,ga=310,ha=60,z=1E3,ia="/",ja="&",ka=/{([\w\-]+)}/g;function la(){return"x"+ ++aa+""+ +new Date}function D(){return+new Date}var H,ma=Math.floor(20*Math.random());H=function(a,c){return 0<a.indexOf("pubsub.")&&a.replace("pubsub","ps"+(c?na().split("-")[0]:20>++ma?ma:ma=1))||a};
...
function ya(a){function c(){}function b(a){a&&(B.h=0);!B.h&&B.length&&(B.h=1,w(B.shift()))}function d(a){var b=0;M(xa(E),function(c){if(c=E[c])b++,(a||t())(c)});return b}function e(){da()||q(1,{error:"Offline. Please check your network settings. "});setTimeout(e,z)}function i(){x.time(function(a){f(t(),a);a||q(1,{error:"Heartbeat failed to connect to Pubnub Servers.Please check your network settings."});setTimeout(i,g)})}function q(a,b){N&&N(a,b);N=n}function f(a,b){function c(b){b&&(ea=D()-(b/1E4+
(D()-d)/2),a&&a(ea))}var d=D();b&&c(b)||x.time(c)}var s=+a.windowing||ca,L=(+a.timeout||ga)*z,g=(+a.keepalive||ha)*z,j=a.noleave||0,l=a.publish_key||"demo",k=a.subscribe_key||"demo",m=a.auth_key||"",A=a.secret_key||"",h=a.PNSDK||"",I=a.hmac_SHA256,F=a.ssl?"s":"",J=a.origin,K="http"+F+"://"+J,y=H(K),oa=H(K),B=[],ea=0,pa=0,qa=0,N=0,fa=0,O=0,E={},w=a.xdr,p=a.error||t(),da=a._is_online||function(){return 1},C=a.jsonp_cb||function(){return 0},P=a.db||{get:t(),set:t()},G=a.uuid||P&&P.get(k+"uuid")||"",
...
"true";l.count=c;l.reverse=d;l.auth=f;s&&(l.callback=s);ra&&(l.start=ra);i&&(l.end=i);w({a:s,data:l,c:function(a){"object"==typeof a&&a.error?e(a):b(a)},b:e,url:[y,"v2","history","sub-key",k,"channel",encodeURIComponent(h)]})},replay:function(a){var b=b||a.callback||t(),c=a.auth_key||m,d=a.source,e=a.destination,f=a.stop,h=a.start,i=a.end,s=a.reverse,a=a.limit,g=C(),j={};if(!d)return p("Missing Source Channel");if(!e)return p("Missing Destination Channel");if(!l)return p("Missing Publish Key");if(!k)return p("Missing Subscribe Key");
"0"!=g&&(j.callback=g);f&&(j.stop="all");s&&(j.reverse="true");h&&(j.start=h);i&&(j.end=i);a&&(j.count=a);j.auth=c;w({a:g,c:function(a){"object"==typeof a&&a.error?err(a):b(a)},b:function(){b([0,"Disconnected"])},url:[y,"v1","replay",l,k,d,e],data:j})},auth:function(a){m=a;c()},time:function(a){var b=C();w({a:b,data:{uuid:G,auth:m},timeout:5*z,url:[y,"time",b],c:function(b){a(b[0])},b:function(){a(0)}})},publish:function(a,c){var c=c||a.callback||t(),d=a.message,e=a.channel,f=a.auth_key||m,h=a.error||
t(),i=C();if(!d)return p("Missing Message");if(!e)return p("Missing Channel");if(!l)return p("Missing Publish Key");if(!k)return p("Missing Subscribe Key");d=JSON.stringify(d);B.push({a:i,timeout:5*z,url:[y,"publish",l,k,0,encodeURIComponent(e),i,encodeURIComponent(d)],data:{uuid:G,auth:f},b:function(a){h(a);b(1)},c:function(a){"object"==typeof a&&a.error?h(a):c(a);b(1)}});b()},unsubscribe:function(a){a=a.channel;O=0;fa=1;a=Q((a.join?a.join(","):""+a).split(","),function(a){return a+","+a+v}).join(",");
M(a.split(","),function(a){u&&x.LEAVE(a,0);E[a]=0});c()},subscribe:function(a,b){function e(a){a?setTimeout(c,z):(y=H(K,1),oa=H(K,1),setTimeout(function(){x.time(e)},z));d(function(b){if(a&&b.d)return b.d=0,b.n(b.name);!a&&!b.d&&(b.d=1,b.l(b.name))})}function h(){var a=C(),b=xa(E).join(",");b&&(q(),N=w({timeout:Ka,a:a,b:function(a){B(a);N=n;x.time(e)},data:{uuid:G,auth:i},url:[oa,"subscribe",k,encodeURIComponent(b),a,O],c:function(a){N=n;if(!a||"object"==typeof a&&"error"in a&&a.error)return B(a),
setTimeout(c,z);I(a[1]);O=!O&&fa&&P.get(k)||a[1];d(function(a){a.f||(a.f=1,a.k(a.name))});J&&(O=1E4,J=0);P.set(k,a[1]);var b,e=(2<a.length?a[2]:Q(E,function(b){return Q(Array(a[0].length).join(",").split(","),function(){return b})}).join(",")).split(",");b=function(){var a=e.shift()||qa;return[(E[a]||{}).a||pa,a.split(v)[0]]};var f=D()-ea-+a[1]/1E4;M(a[0],function(c){var d=b();d[0](c,a,d[1],f)});setTimeout(h,sa)}}))}var f=a.channel,b=(b=b||a.callback)||a.message,i=a.auth_key||m,l=a.connect||t(),j=
a.reconnect||t(),g=a.disconnect||t(),B=a.error||t(),I=a.idle||t(),A=a.presence||0,F=a.noheresync||0,J=a.backfill||0,da=a.timetoken||0,Ka=a.timeout||L,sa=a.windowing||s;fa=a.restore;O=da;if(!f)return p("Missing Channel");if(!b)return p("Missing Callback");if(!k)return p("Missing Subscribe Key");M((f.join?f.join(","):""+f).split(","),function(a){var c=E[a]||{};E[qa=a]={name:a,f:c.f,d:c.d,j:1,a:pa=b,k:l,l:g,n:j};A&&(x.subscribe({channel:a+v,callback:A}),!c.j&&!F&&x.here_now({channel:a,callback:function(b){M("uuids"in
b?b.uuids:[],function(c){A({action:"join",uuid:c,timestamp:D(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){q();setTimeout(h,sa)};if(!u)return ba.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||t(),d=a.auth_key||m,e=a.channel,f=C(),d={uuid:G,auth:d};if(!e)return p("Missing Channel");if(!b)return p("Missing Callback");if(!k)return p("Missing Subscribe Key");"0"!=f&&(d.callback=f);w({a:f,data:d,c:function(a){"object"==typeof a&&a.error?c(a):b(a)},b:c,url:[y,"v2","presence",
"sub_key",k,"channel",encodeURIComponent(e)]})},grant:function(a,b){var b=a.callback||b,c=a.error||t(),d=a.channel,e=C(),f=a.ttl||-1,i=a.read?"1":"0",j=a.write?"1":"0",s=a.auth_key;if(!d)return p("Missing Channel");if(!b)return p("Missing Callback");if(!k)return p("Missing Subscribe Key");if(!l)return p("Missing Publish Key");if(!A)return p("Missing Secret Key");"0"!=e&&(g.callback=e);var g=Math.floor((new Date).getTime()/1E3),m=I(k+"\n"+l+"\ngrant\n"+(s&&0<encodeURIComponent(s).length?"auth="+encodeURIComponent(s)+
"&":"")+"channel="+encodeURIComponent(d)+"&pnsdk="+encodeURIComponent(h)+"&r="+i+"&timestamp="+encodeURIComponent(g)+(-1<f?"&ttl="+f:"")+"&w="+j,A),m=m.replace(/\+/g,"-"),m=m.replace(/\//g,"_"),g={w:j,r:i,signature:m,channel:encodeURIComponent(d),timestamp:g};-1<f&&(g.ttl=f);s&&(g.auth=encodeURIComponent(s));w({a:e,data:g,c:function(a){b(a)},b:c,url:[y,"v1","auth","grant","sub-key",k]})},audit:function(a,b){var b=a.callback||b,c=a.error||t(),d=a.channel,e=a.auth_key,f=C();if(!b)return p("Missing Callback");
if(!k)return p("Missing Subscribe Key");if(!l)return p("Missing Publish Key");if(!A)return p("Missing Secret Key");"0"!=f&&(i.callback=f);var i=Math.floor((new Date).getTime()/1E3),g=k+"\n"+l+"\naudit\n";e&&(g+="auth="+encodeURIComponent(e)+"&");d&&(g+="channel="+encodeURIComponent(d)+"&");var g=g+("pnsdk="+encodeURIComponent(h)+"&timestamp="+i),g=I(g,A),g=g.replace(/\+/g,"-"),g=g.replace(/\//g,"_"),i={signature:g,timestamp:i};d&&(i.channel=encodeURIComponent(d));e&&(i.auth=encodeURIComponent(e));
w({a:f,data:i,c:function(a){b(a)},b:c,url:[y,"v1","auth","audit","sub-key",k]})},revoke:function(a,b){a.read=r;a.write=r;x.grant(a,b)},origin:function(){return J},xdr:w,ready:R,db:P,uuid:na,map:Q,each:M,"each-channel":d,grep:va,offline:function(){q(1)},supplant:wa,now:D,unique:la,updater:ua};G||(G=x.uuid());P.set(k+"uuid",G);setTimeout(e,z);setTimeout(i,g);f();return x}
...
b){function c(e){d||(d=!0,(a.callback||b||t())(e))}var d=r,f=na();e[0].m(a,c);a.channel+="-ha";a.message={u:f,payload:a.message};M(e,function(b){a.message.o=b.origin();b.m(a,c)})};f.subscribe=function(a,b){var c=a.channel,f=[];M((c.join?c.join(","):""+c).split(","),function(a){f.push(a+"-ha")});1<d&&(a.channel=f);M(e,function(c){c.p(a,function(d,e,f){a:{var g=c.origin();if("object"===typeof d&&"u"in d){var j=d.q;if(j in i)break a;i[j]=D();d.rx=g;d=d.payload}(a.callback||a.message||b||t())(d,e,f)}})})};
f.css=Da;f.$=S;f.create=Ea;f.bind=T;f.head=Ca;f.search=Ba;f.attr=U;f.events=Y;f.init=Na;T("beforeunload",window,function(){f["each-channel"](function(a){f.LEAVE(a.name,0)});return!0});if(a.notest)return f;T("offline",window,f.offline);T("offline",document,f.offline);return f};"complete"===document.readyState?setTimeout(R,0):T("load",window,function(){setTimeout(R,0)});var $=Z||{};PUBNUB=Na({notest:1,publish_key:U($,"pub-key"),subscribe_key:U($,"sub-key"),ssl:!document.location.href.indexOf("https")||
...
W[a].responseText=unescape(c);W[a].onload()};W.id=z}}
