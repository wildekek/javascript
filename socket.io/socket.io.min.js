...
c){for(var b in c)if(c.hasOwnProperty(b))try{a.style[b]=c[b]+(0<"|width|height|top|left|".indexOf(b)&&"number"==typeof c[b]?"px":"")}catch(d){}},Oa=function(a){return document.createElement(a)},Ta=function(){return Ra||Sa()?0:fa()},Va=function(a){function c(a,b){y||(y=1,u.onerror=v,clearTimeout(h),a||!b||g(b),setTimeout(function(){a&&i();var b=Ha(B),c=b&&b.parentNode;c&&c.removeChild(b)},I))}if(Ra||Sa()){a:{var b,d,e=function(){if(!m){m=1;clearTimeout(r);try{d=JSON.parse(b.responseText)}catch(a){return q(1)}f=
...
default:try{d=JSON.parse(b.responseText)}catch(a){return q(1,{status:b.status,fb:v,message:b.responseText})}q(1,d)}};var E=la(a.url,x);b.open("GET",E,A);A&&(b.timeout=j);b.send()}catch(H){q(0);Ra=0;a=Va(a);break a}a=q}return a}var u=Oa("script"),e=a.e,B=fa(),y=0,h=setTimeout(function(){c(1,{message:"timeout"})},a.timeout||Ua),i=a.f||D(),j=a.data||{},g=a.g||D();window[e]=function(a){c(0,a)};a.Q||(u[Wa]=Wa);u.onerror=function(){c(1)};u.src=la(a.url,j);Ma(u,"id",B);La().appendChild(u);return c},Xa=function(){if(!("onLine"in
navigator))return 1;try{return navigator.onLine}catch(a){return p}},Ya=function(a){return!("sendBeacon"in navigator)?w:navigator.sendBeacon(a)},Sa=function(){if(!Za||!Za.get)return 0;var a={id:Sa.id++,send:D(),abort:function(){a.id={}},open:function(c,b){Sa[a.id]=a;Za.get(a.id,b)}};return a},ea=1,Ba=w,Ca=[],$a="-pnpres",Ua=15E3,I=1E3,ja="/",ka="&",ra=/{([\w\-]+)}/g,ab,bb=Math.floor(20*Math.random());ab=function(a,c){return 0<a.indexOf("pubsub.")&&a.replace("pubsub","ps"+(c?ta().split("-")[0]:20>++bb?
...
ia();b&&c(b)||G.time(c)}function d(a,b){hb&&hb(a,b);hb=v;clearTimeout(aa);clearTimeout(ba)}function e(){Kc&&G.time(function(a){b(D(),a);a||d(1,{error:"Heartbeat failed to connect to Pubnub Servers.Please check your network settings."});ba&&clearTimeout(ba);ba=setTimeout(e,Ub)})}function f(){Nc()||d(1,{error:"Offline. Please check your network settings. "});aa&&clearTimeout(aa);aa=setTimeout(f,I)}function m(a,b,c,d){var b=a.callback||b,e=a.error||t,f=S(),d=d||{};d.auth||(d.auth=a.auth_key||J);a=[U,
...
a.callback||D(),c=a.auth_key||J,d=a.source,e=a.destination,f=a.stop,h=a.start,g=a.end,j=a.reverse,i=a.limit,l=S(),m={};if(!d)return t("Missing Source Channel");if(!e)return t("Missing Destination Channel");if(!ca)return t("Missing Publish Key");if(!z)return t("Missing Subscribe Key");"0"!=l&&(m.callback=l);f&&(m.stop="all");j&&(m.reverse="true");h&&(m.start=h);g&&(m.end=g);i&&(m.count=i);m.auth=c;N({e:l,g:function(a){r(a,b,err)},f:function(){b([0,"Disconnected"])},url:[U,"v1","replay",ca,z,d,e],data:B(m)})},
auth:function(a){J=a;c()},time:function(a){var b=S(),c={uuid:M,auth:J};ha&&(c.instanceid=$);N({e:b,data:B(c),url:[U,"time",b],g:function(b){a(b[0])},f:function(){a(0)}})},publish:function(a,b){var c=a.message;if(!c)return t("Missing Message");var b=b||a.callback||c.callback||D(),d=a.channel||c.channel,e=a.auth_key||J,f=a.cipher_key,h=a.error||c.error||D(),g=a.post||w,i="store_in_history"in a?a.store_in_history:p,l=S(),m="push";a.prepend&&(m="unshift");if(!d)return t("Missing Channel");if(!ca)return t("Missing Publish Key");
if(!z)return t("Missing Subscribe Key");c.getPubnubMessage&&(c=c.getPubnubMessage());c=JSON.stringify(ib.encrypt(c,f||ga)||c);c=[U,"publish",ca,z,0,encodeURIComponent(d),l,encodeURIComponent(c)];e={uuid:M,auth:e};i||(e.store="0");ha&&(e.instanceid=$);ma[m]({e:l,url:c,data:B(e),f:function(a){j(a,h);s(1)},g:function(a){r(a,b,h);s(1)},mode:g?"POST":"GET"});s()},unsubscribe:function(a,b){var d=a.channel,e=a.channel_group,f=a.auth_key||J,b=b||a.callback||D(),h=a.error||D();xa=0;Qa=1;if(d){var g=va((d.join?
d.join(","):""+d).split(","),function(a){if(L[a])return a}).join(","),d=va((d.join?d.join(","):""+d).split(","),function(a){if(L[a])return a+","+a+$a}).join(",");F(d.split(","),function(a){a&&(L[a]=0,a in da&&delete da[a])});d=p;Ba&&(d=G.LEAVE(g,0,f,b,h));d||b({action:"leave"})}e&&(g=va((e.join?e.join(","):""+e).split(","),function(a){if(Y[a])return a}).join(","),e=va((e.join?e.join(","):""+e).split(","),function(a){if(Y[a])return a+","+a+$a}).join(","),F(e.split(","),function(a){a&&(Y[a]=0,a in da&&
delete da[a])}),d=p,Ba&&(d=G.LEAVE_GROUP(g,0,f,b,h)),d||b({action:"leave"}));c()},subscribe:function(a,b){function e(a){a?setTimeout(c,aa):(U=ab(Ea,1),dc=ab(Ea,1),setTimeout(function(){G.time(e)},I));C(function(b){if(a&&b.i)return b.i=0,b.aa(b.name);!a&&!b.i&&(b.i=1,b.W(b.name))});x(function(b){if(a&&b.i)return b.i=0,b.aa(b.name);!a&&!b.i&&(b.i=1,b.W(b.name))})}function f(){var a=S(),b=za(L).join(","),h=Aa(Y).join(",");if(b||h){b||(b=",");d();var g=B({uuid:M,auth:J});h&&(g["channel-group"]=h);2<JSON.stringify(da).length&&
(g.state=JSON.stringify(da));Z&&(g.heartbeat=Z);ha&&(g.instanceid=$);A();hb=N({timeout:ma,e:a,f:function(a){a&&a.error&&a.service?(e(1),j(a,s)):G.time(function(b){!b&&j(a,s);e(b)})},data:B(g),url:[dc,"subscribe",z,encodeURIComponent(b),a,xa],g:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return s(a.error),setTimeout(c,I);u(a[1]);xa=!xa&&Qa&&ya.get(z)||a[1];C(function(a){a.s||(a.s=1,a.T(a.name))});x(function(a){a.s||(a.s=1,a.T(a.name))});if(Cb&&!Qa)xa=0,Cb=w,ya.set(z,0),setTimeout(f,
aa);else{V&&(xa=1E4,V=0);ya.set(z,a[1]);var b,d="",e="";3<a.length?(d=a[3],e=a[2]):d=2<a.length?a[2]:va(za(L),function(b){return va(Array(a[0].length).join(",").split(","),function(){return b})}).join(",");var h=d.split(","),g=e?e.split(","):[];b=function(){var a=h.shift()||ec,b=g.shift(),c={};b?(a&&(0<=a.indexOf("-pnpres")&&0>b.indexOf("-pnpres"))&&(b+="-pnpres"),c=Y[b]||L[b]||{callback:D()}):c=L[a];a=[c.e||Bb,a.split($a)[0]];b&&a.push(b.split($a)[0]);return a};var i=ia()-yb-+a[1]/1E4;setTimeout(f,
aa);F(a[0],function(c){var d=b(),c=E(c,L[d[1]]?L[d[1]].cipher_key:v);d[0]&&d[0](c,a,d[2]||d[1],i,d[1])})}}})}}var h=a.channel,i=a.channel_group,b=(b=b||a.callback)||a.message,m=a.connect||D(),r=a.reconnect||D(),q=a.disconnect||D(),s=a.error||s||D(),u=a.idle||D(),y=a.presence||0,H=a.noheresync||0,V=a.backfill||0,ca=a.timetoken||0,ma=a.timeout||l,aa=a.windowing||g,ba=a.state,ga=a.heartbeat||a.pnexpires,na=a.heartbeat_interval,oa=a.restore||Qa;J=a.auth_key||J;Qa=oa;xa=ca;if(!h&&!i)return t("Missing Channel");
if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");(ga||0===ga||na||0===na)&&G.set_heartbeat(ga,na);h&&F((h.join?h.join(","):""+h).split(","),function(c){var d=L[c]||{};L[ec=c]={name:c,s:d.s,i:d.i,o:1,e:Bb=b,cipher_key:a.cipher_key,T:m,W:q,aa:r};ba&&(da[c]=c in ba?ba[c]:ba);y&&(G.subscribe({channel:c+$a,callback:y,restore:oa}),!d.o&&!H&&G.here_now({channel:c,data:B({uuid:M,auth:J}),callback:function(a){F("uuids"in a?a.uuids:[],function(b){y({action:"join",uuid:b,timestamp:Math.floor(ia()/
1E3),occupancy:a.occupancy||1},a,c)})}}))});i&&F((i.join?i.join(","):""+i).split(","),function(c){var d=Y[c]||{};Y[c]={name:c,s:d.s,i:d.i,o:1,e:Bb=b,cipher_key:a.cipher_key,T:m,W:q,aa:r};y&&(G.subscribe({channel_group:c+$a,callback:y,restore:oa,auth_key:J}),!d.o&&!H&&G.here_now({channel_group:c,data:B({uuid:M,auth:J}),callback:function(a){F("uuids"in a?a.uuids:[],function(b){y({action:"join",uuid:b,timestamp:Math.floor(ia()/1E3),occupancy:a.occupancy||1},a,c)})}}))});c=function(){d();setTimeout(f,
aa)};if(!Ba)return Ca.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.debug,d=a.error||D(),e=a.auth_key||J,f=a.channel,h=a.channel_group,g=S(),i=a.state,e={uuid:M,auth:e};if(!("uuids"in a?a.uuids:1))e.disable_uuids=1;i&&(e.state=1);if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");i=[U,"v2","presence","sub_key",z];f&&i.push("channel")&&i.push(encodeURIComponent(f));"0"!=g&&(e.callback=g);h&&(e["channel-group"]=h,!f&&i.push("channel")&&i.push(","));ha&&(e.instanceid=
$);N({e:g,data:B(e),g:function(a){r(a,b,d)},f:function(a){j(a,d)},debug:c,url:i})},where_now:function(a,b){var b=a.callback||b,c=a.error||D(),d=a.auth_key||J,e=S(),f=a.uuid||M,d={auth:d};if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");"0"!=e&&(d.callback=e);ha&&(d.instanceid=$);N({e:e,data:B(d),g:function(a){r(a,b,c)},f:function(a){j(a,c)},url:[U,"v2","presence","sub_key",z,"uuid",encodeURIComponent(f)]})},state:function(a,b){var b=a.callback||b||D(),c=a.error||D(),d=a.auth_key||
J,e=S(),f=a.state,h=a.uuid||M,g=a.channel,i=a.channel_group,d=B({auth:d});if(!z)return t("Missing Subscribe Key");if(!h)return t("Missing UUID");if(!g&&!i)return t("Missing Channel");"0"!=e&&(d.callback=e);"undefined"!=typeof g&&L[g]&&L[g].o&&f&&(da[g]=f);"undefined"!=typeof i&&(Y[i]&&Y[i].o)&&(f&&(da[i]=f),d["channel-group"]=i,g||(g=","));d.state=JSON.stringify(f);ha&&(d.instanceid=$);f=f?[U,"v2","presence","sub-key",z,"channel",g,"uuid",h,"data"]:[U,"v2","presence","sub-key",z,"channel",g,"uuid",
encodeURIComponent(h)];N({e:e,data:B(d),g:function(a){r(a,b,c)},f:function(a){j(a,c)},url:f})},grant:function(a,b){var b=a.callback||b,c=a.error||D(),d=a.channel||a.channels,e=a.channel_group,f=S(),h=a.ttl,g=a.read?"1":"0",i=a.write?"1":"0",l=a.manage?"1":"0",m=a.auth_key||a.auth_keys;if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");if(!ca)return t("Missing Publish Key");if(!jb)return t("Missing Secret Key");var q=z+"\n"+ca+"\ngrant\n",g={w:i,r:g,timestamp:Math.floor((new Date).getTime()/
...
D(),c=a.auth_key||J,d=a.error||D(),e=S(),f=a.channel,g=a.op,h=a.gw_type,a=a.device_id;if(!a)return t("Missing Device ID (device_id)");if(!h)return t("Missing GW Type (gw_type: gcm or apns)");if(!g)return t("Missing GW Operation (op: add or remove)");if(!f)return t("Missing gw destination Channel (channel)");if(!ca)return t("Missing Publish Key");if(!z)return t("Missing Subscribe Key");a=[U,"v1/push/sub-key",z,"devices",a];c={uuid:M,auth:c,type:h};"add"==g?c.add=f:"remove"==g&&(c.remove=f);ha&&(data.instanceid=
$);N({e:e,data:c,g:function(a){r(a,b,d)},f:function(a){j(a,d)},url:a})},audit:function(a,b){var b=a.callback||b,c=a.error||D(),d=a.channel,e=a.channel_group,f=a.auth_key,g=S();if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");if(!ca)return t("Missing Publish Key");if(!jb)return t("Missing Secret Key");var h=z+"\n"+ca+"\naudit\n",i={timestamp:Math.floor((new Date).getTime()/1E3)};"0"!=g&&(i.callback=g);"undefined"!=typeof d&&(d!=v&&0<d.length)&&(i.channel=d);"undefined"!=typeof e&&
(e!=v&&0<e.length)&&(i["channel-group"]=e);f&&(i.auth=f);i=B(i);f||delete i.auth;h+=u(i);d=cc(h,jb);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");i.signature=d;N({e:g,data:i,g:function(a){r(a,b,c)},f:function(a){j(a,c)},url:[U,"v1","auth","audit","sub-key",z]})},revoke:function(a,b){a.read=w;a.write=w;G.grant(a,b)},set_uuid:function(a){M=a;c()},get_uuid:function(){return M},isArray:function(a){return ua(a)},get_subscibed_channels:function(){return za(L,p)},presence_heartbeat:function(a){var b=a.callback||
D(),c=a.error||D(),a=S(),d={uuid:M,auth:J};2<JSON.stringify(da).length&&(d.state=JSON.stringify(da));0<Z&&320>Z&&(d.heartbeat=Z);"0"!=a&&(d.callback=a);var e;e=za(L,p).join(",");e=encodeURIComponent(e);var f=Aa(Y,p).join(",");e||(e=",");f&&(d["channel-group"]=f);ha&&(d.instanceid=$);N({e:a,data:B(d),url:[U,"v2","presence","sub-key",z,"channel",e,"heartbeat"],g:function(a){r(a,b,c)},f:function(a){j(a,c)}})},stop_timers:function(){clearTimeout(aa);clearTimeout(ba);clearTimeout(na)},shutdown:function(){G.stop_timers();
gc&&gc()},xdr:N,ready:Da,db:ya,uuid:ta,map:va,each:F,"each-channel":C,grep:qa,offline:function(){d(1,{message:"Offline. Please check your network settings."})},supplant:sa,now:ia,unique:fa,updater:pa};M||(M=G.uuid());$||($=G.uuid());ya.set(z+"uuid",M);aa=setTimeout(f,I);ba=setTimeout(e,Ub);na=setTimeout(A,(V-3)*I);b();var h=G,lb;for(lb in h)h.hasOwnProperty(lb)&&(y[lb]=h[lb]);y.css=Na;y.$=Ha;y.create=Oa;y.bind=Ka;y.head=La;y.search=Ja;y.attr=Ma;y.events=qb;y.init=y;y.secure=y;y.crypto_obj=Fa();Ka("beforeunload",
window,function(){if(i)y["each-channel"](function(a){y.LEAVE(a.name,0)});return p});if(a.notest)return y;Ka("offline",window,y.offline);Ka("offline",document,y.offline);return y};sb.init=sb;sb.secure=sb;sb.crypto_obj=Fa();"complete"===document.readyState?setTimeout(Da,0):Ka("load",window,function(){setTimeout(Da,0)});var tb=rb||{};PUBNUB=sb({notest:1,publish_key:Ma(tb,"pub-key"),subscribe_key:Ma(tb,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==Ma(tb,"ssl"),origin:Ma(tb,"origin"),
uuid:Ma(tb,"uuid")});window.jQuery&&(window.jQuery.PUBNUB=sb);"undefined"!==typeof module&&(module.exports=PUBNUB)&&Da();var Za=Ha("pubnubs")||0;if(rb){Na(rb,{position:"absolute",top:-I});if("opera"in window||Ma(rb,"flash"))rb.innerHTML="<object id=pubnubs data=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=movie value=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=allowscriptaccess value=always></object>";PUBNUB.rdx=function(a,c){if(!c)return Sa[a].onerror();Sa[a].responseText=unescape(c);
Sa[a].onload()};Sa.id=I}}
