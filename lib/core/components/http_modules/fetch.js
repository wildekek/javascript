...
exports.default = {
  POST: function POST(_ref2) {
    ...
    return _abstractedXDR({ fetchUrl: fetchUrl, method: 'GET', endpoint: endpoint, callback: callback, body: body });
  },
  ...
  GET: function GET(_ref3) {
    ...
    var fetchUrl = createURL(endpoint.origin, endpoint.url, queryParams);
    return _abstractedXDR({ fetchUrl: fetchUrl, method: 'POST', endpoint: endpoint, callback: callback });
  }
};
